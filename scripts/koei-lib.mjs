...
export const CITIES = {
  ...
  sagamihara: {
    ...
    keyOf: (r) => [r.name, r.cat, r.madori],
    cols: [['name', '団地'], ['cat', '募集区分'], ['madori', '間取り']],
    note: '同じ団地でも募集区分（一般向・高齢者単身者向など）と間取りが違えば別に数えています。区分は申込みの資格そのものが違い、間取りが違えば倍率もまるで違うためです。資料では「一般向 ○3DK」のように区分と間取りが1つの欄に入っているので、当方で分けました（○▲■などの印は資料の凡例の目印なので落としています）。',
    ...
    thin: '相模原市営住宅は<strong>団地が39しかなく</strong>、他市より母数が小さい資料です。4件以上観測できた申込先は44件で、川崎244件・神戸155件・横浜114件と比べるとはっきり薄いことを承知のうえでご覧ください。',
  },
}
